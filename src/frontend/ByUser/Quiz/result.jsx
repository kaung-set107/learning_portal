        ...
        <div className='mx-8 mt-5'>
            <Card>
                ...
                {/* {/* <div>
                    ...
                    <div>
                        {/* {console.log((quizResult.updatedQuestions.map((i) => (parseInt(i.correctAnswer) === parseInt(i.studentAnswer)))), 'quest')} */}
                {/* {(quizList.filter(el => el._id === quizID)).map((i) => (i.questions))[0].map((i) => (
                    <>
                        {i.options.filter(el => el.answer === quizResult.studentAnswer) ? (
                            <div className="mt-3">
                                <Stack sx={{ width: "50%" }}>
                ...
                <div className='py-3 mt-3' >
                    <Button color='secondary' size='sm' className='ml-10 rounded-md mt-3' onClick={() => handleBack()} >Back</Button>
                </div >
            </Card >
        </div >
    )
