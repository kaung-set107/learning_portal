...
const About = () => {
  ...
  return (
    <div className=''>
      ...
      <div className='hidden 2xl:flex items-center justify-around gap-48 flex-wrap h-[615px] ' style={{ backgroundImage: `url(${HeadImg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
        <div className='flex flex-col gap-32 overflow-hidden'>
          <div className='flex flex-col justify-center '>
            <span className='text-[20px] sm:text-[30px] md:text-[30px] lg:text-[40px] 2xl:[48px] font-medium text-[#fff] flex justify-center'>"Explore Limitless Opportunities:</span>
            <span className='text-[20px] sm:text-[30px] md:text-[30px] lg:text-[40px] 2xl:[48px] font-medium text-[#fff] flex justify-center'>Your Gateway to Overseas MSI Education"</span>
      ...
      <div className='flex flex-col gap-20 sm:gap-32 md:gap-0 2xl:container'>

        {/* About MSI */}
        <div className=' absolute  md:pl-[45px] lg:pl-[35px] xl:pl-[36px] 2xl:pl-[100px] pr-[50px] top-[600px] md:top-[650px] lg:top-[560px] xl:top-[570px] 2xl:top-[740px] lg:mt-[120px]'>
          <div className='flex flex-col md:flex-col lg:flex-col  xl:flex-row xl:gap-32 gap-10 md:gap-10 lg:gap-0 pl-[10px] md:pl-[78px] md:pt-[20px] lg:pt-[50px] lg:pl-[40px]  md:pr-[75px] bg-white w-[300px] sm:w-[500px] md:w-[680px] lg:w-[950px] xl:w-[1200px] xl:h-[450px] h-[556px] md:h-[800px] lg:h-[730px] 2xl:w-[1200px] 2xl:h-[500px]'>
            ...
            // <small className='text-[#BC1F40]'>MSI Academy</small> */}
              ...
              <p className='font-normal text-[16px] my-5 w-[350px] sm:w-[550px] md:w-[559px] lg:w-[900px] xl:w-[550px]'>
            ...
            <div className='my-2 md:my-10 relative'>
              <iframe
                className='sm:container w-[360px] sm:w-[590px] md:w-[550px] h-[200px]  md:h-[300px] lg:w-[850px] xl:w-[450px] xl:h-[300px] lg:h-[300px] 2xl:w-[500px]'
        ...
        {/* Founder For 640px */}
        <div className='w-[300px] sm:w-[550px] container md:w-full h-[420px] flex md:hidden flex-col gap-10 justify-center items-center pt-[1400px] sm:pt-[800px] md:pt-[290px] '>
          <h1 className='flex justify-center items-center w-[400px] text-[25px] sm:text-[35px] text-[#1C4064] font-[semibold] '>
            Founders of MSI Academy
          </h1>
          <div className='sm:flex sm:flex-row grid grid-cols-1 gap-4 sm:gap-2 justify-center mt-5'>

            <div
              className=' rounded-[20px]'
            >
              <Image
                className='w-[300px] h-[350px] sm:w-[450px] sm:h-[250px]'
                src={Team2}
              />
              <p className='font-[semibold] my-1 text-[18px] tracking-[0.02em] text-[#000] text-center'>
                Vice President
              </p>
              <p className='font-[light] text-[18px] tracking-[0.02em] text-[#000] text-center'>
                Mr. Thet Win Naing
              </p>
            </div>
            <div
            ...
            >
              <Image
                className='w-[300px] h-[300px] sm:w-[450px] sm:h-[250px]'
                src={Team1}
              />
              <p className='font-[semibold] my-1 text-[18px] tracking-[0.02em] text-[#000] text-center'>
                President
        ...
        <div className='pt-[500px] sm:pt-[50px] md:pt-[200px]'></div>
        <StudentAchievements />
        <div className='' style={{
