...
export default function Result() {
    ...
    const FunQuizData = location.state.FunQuizRes
    // console.log(FunQuizData, 'FunQuizData')
    const dataFromLocalStorage = localStorage.getItem("id");
    const navigate = useNavigate();
    const quizResult = FunQuizData;
    const [quizList, setQuizList] = useState([]);
    const [quizID, setQuizID] = useState("");
    const [studentList, setStudentList] = useState([]);
    const updatedQuestionList = FunQuizData?.updatedQuestionData
    ...
    useEffect(() => {
        ...
        const marks = quizResult.updatedQuestionData
                    ...
                    <div className='flex flex-row gap-48 pt-14 lg:pt-5'>
                        ...
                        <div className='flex flex-col gap-10 lg:gap-5 w-[887px] lg:w-[700px] h-[570px] pl-24 pt-14'>
                            ...
                            <div className='flex gap-20 w-[855px] h-[52px]'>
                                ...
                                <span className='text-[20px] text-[#000] font-bold'>
                                    {originMark === quizResult.totalMark ? 'Nice !' : 'Try !'}
                                </span>
                            </div>
                        </div>
                        {/* Right Side */}
