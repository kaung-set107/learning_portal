...
export default function QuizPage() {
  ...
  const nextQuestion = (cas, ind) => {
    ...
    let answerObj =
      quiz.questions.filter((ans, i) => i === ind)[0].correctAnswer === cas;
  ...
  return (
    <div className='flex justify-center'>
      ...
      {showTimer && (
        <>
          <div>
            <ProgressBar value={1 * 60 + 0} max={1 * 60} />
                ...
                <Card className='mt-5 p-5 mb-10' key={index}>
                    ...
                    <div className='mt-5'>
                      {item.answers.map((e, i) => (
                        <div
                          ...
                          onClick={() =>
                            handleAns(i, item.correctAnswer, index)
                          }
                        >
                          <label>
                            {/* <input
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => nextQuestion(item.correctAnswer, index)}
                    >
                      Next
                    </Button>
                  </div>
