...
import { faEye, faClock, faCalendarDays } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div>
            ...
            <div className='flex flex-col gap-5 p-6'>
                ...
                <div>
                    <div className='flex flex-col gap-20 w-full h-[1500px] mt-10'>
                        {/* First Section */}
                        ...
                        <div className='flex gap-20'>
                            <div>
                                <Image src={PF} className='rounded-[50%]' />
                            </div>
                            <div className='flex flex-col gap-2'>
                                <span className='text-[24px] font-semibold'>Aria Josh</span>
                                <span className='text-[16px] font-semibold'>Student ID : TIPSG5682</span>
