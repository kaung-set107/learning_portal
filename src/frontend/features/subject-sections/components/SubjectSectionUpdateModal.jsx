...
export default function SubjectSectionUpdateModal(props) {
  ...
  let { subjectId, subjectSectionData, subjectSectionId, successCallback } =
    props;
  ...
  if (isLoading) {
    ...
    content = (
      <>
        <CustomButton onPress={onOpen} color="success" title="Update" />
        <Modal
          isOpen={isOpen}
