    ...
    <div className='gap-4'>
      ...
      <div className='flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4 mt-3'>
        <div className='block w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4'>
          ...
          >
            <option value={department ? department.level : ""} hidden>
              {department ? department.level : "Not Set"}
            </option>
        ...
        <div className='block w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4'>
          ...
          <select
            ...
            className='bg-gray-100 border mt-2 border-gray-300 text-gray-900 text-sm rounded-xl m-0 px-0 py-2 focus:ring-gray-500 focus:border-gray-500 block w-full p-3 dark:bg-default-100 dark:border-gray-600 dark:placeholder-gray-100 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500'
          >
            <option value={department ? department.function : ""} hidden>
              {department ? department.function : "Not Set"}
            </option>
      ...
      <div className='flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4 mt-3'>
        <div className='block w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4'>
          ...
          <select
            ...
            className='bg-gray-100 border mt-2 border-gray-300 text-gray-900 text-sm rounded-xl m-0 px-0 py-2 focus:ring-gray-500 focus:border-gray-500 block w-full p-3 dark:bg-default-100 dark:border-gray-600 dark:placeholder-gray-100 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500'
          >
            <option value={department ? department.activities : ""} hidden>
              {department ? department.activities : "Not Set"}
            </option>
        ...
        <div className='block w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4'>
          ...
          >
            <option
              value={
                department && department.reportingTo
                  ? department.reportingTo._id
                  : ""
              }
              hidden
            >
              {department && department.reportingTo
                ? department.reportingTo.name
                : "Not Set"}{" "}
            </option>
      ...
      <div className='flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4 mt-3'>
        <div className='block w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4'>
          ...
          >
            <option
              value={
                department && department.directManager
                  ? department.directManager._id
                  : ""
              }
              hidden
            >
              {department && department.directManager
                ? department.directManager.givenName
                : ""}
            </option>
        ...
        <div className='block w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4'>
          ...
          <select
            onChange={(e) =>
              handleInputChange("assistantManager", e.target.value)
            }
            className='bg-gray-100 border mt-2 border-gray-300 text-gray-900 text-sm rounded-xl m-0 px-0 py-2 focus:ring-gray-500 focus:border-gray-500 block w-full p-3 dark:bg-default-100 dark:border-gray-600 dark:placeholder-gray-100 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500'
          >
            <option
              value={
                department && department.assistantManager
                  ? department.assistantManager._id
                  : ""
              }
              hidden
            >
              {department && department.assistantManager
                ? department.assistantManager.givenName
                : ""}
            </option>
            {employeeList.map((item) => (
              <option key={item._id} value={item._id}>
