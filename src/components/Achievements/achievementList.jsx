...
export default function BatchList() {
    ...
    useEffect(() => {
        const getNews = async () => {
            await apiInstance
                .get(`achievements`, { params: { limit: 80, rowsPerPage: rowsPerPage } })
                .then((res) => {
        ...
        <>
            ...
            <div className='flex justify-between items-center mb-3'>
                <span className='text-default-400 text-small'>
                    Total {batchList.length} Achievements
                </span>
            ...
            >
                <TableHeader>
                    ...
                    <TableColumn>Achievement Type</TableColumn>
                ...
                <TableBody emptyContent={"No Positions to display."} >
                    {items.map((item, index) => (
                        <TableRow key={item._id} >
                            ...
                            <TableCell>{item?.type === 'school' ? 'MSI Achievements' : 'Student Achievements'}</TableCell>

                            <TableCell>
                                <div className='relative flex items-center gap-2'>
                                    <Tooltip content='Edit Position'>
                                        <Link to={"/achievement-update/" + item._id}>
